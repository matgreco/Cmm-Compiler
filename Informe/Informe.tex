...
\section*{Probar el AST}
Para correr el analizador sobre un archivo, es solo necesario correr (en Linux) el script \texttt{compile.sh} junto con el archivo de prueba. En este caso, se puede usar

\begin{itemize}
    \item \texttt{./compile.sh tests/error\_do.cmm}
    \item \texttt{./compile.sh tests/error\_if.cmm}
    \item \texttt{./compile.sh tests/test.cmm}
    \item \texttt{./compile.sh tests/test\_comma\_operation.cmm}
    \item \texttt{./compile.sh tests/test\_function\_struct.cmm}
    \item \texttt{./compile.sh tests/test\_struct.cmm}
    \item \texttt{./compile.sh tests/test\_switch.cmm}
\end{itemize}

\subsection*{Ejemplo de \'arbol}
\includegraphics[scale=0.45]{arbol1.jpg}
